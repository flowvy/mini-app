...
| Admin | `/admin/dashboard`, `/admin/users`, `/admin/users/:id`, `/admin/broadcast`, `/admin/settings`, `/admin/settings/kuma`, `/admin/settings/beszel`, `/admin/settings/branding`, `/admin/settings/access`, `/admin/settings/welcome` |
