...
Flowvy — Telegram Mini App и бот для управления VPN-подпиской через Remnawave. Пользователь видит
подписку, устройства и состояние сервиса; администратор — сводку, пользователей и настройки
интеграций/оформления. FastAPI выступает BFF, React-клиент работает только с его API.
