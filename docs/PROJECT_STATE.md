...
Последняя полная проверка: **2026-08-24**; последний change-aware gate: **2026-08-24**. Fresh
tooling/migrations, Ruff, `558` backend tests, `56` pinned contracts, frontend lint/typecheck,
`100` unit tests, production build и `210/210` mobile Chromium Playwright прошли. Focused semantic
