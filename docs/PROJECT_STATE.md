...
Последняя полная проверка: **2026-08-25**; последний change-aware gate: **2026-08-25**. Fresh
tooling/migrations, Ruff, `560` backend tests, `56` pinned contracts, frontend lint/typecheck,
`109` unit tests, production build и `220/220` mobile Chromium Playwright прошли. Focused semantic
