...
Последняя полная проверка: **2026-08-24**; последний change-aware gate: **2026-08-24**. Все стадии
прошли, включая mobile Chromium `203/203` и несупрессированные Axe `color-contrast` scans. Прежний
ledger ADR 0004 закрыт общей accessible Desktop/Mini App palette и больше не даёт completion exception.
