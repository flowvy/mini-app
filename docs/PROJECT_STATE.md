...
Последняя полная проверка: **2026-08-23**; последний change-aware gate: **2026-08-23**. Все
не-accessibility стадии прошли; accessibility gate красный только на принятом ledger ADR 0004.
...
- Identity, Registration & Access и Communication собраны в секции Flowvy Mini-App.
  ...
  только resolved locale, а незаполненные поля используют product fallback. Support и Broadcast
  используют общий product-owned `Coming Soon` без provider content, destination или action. Access editor не
