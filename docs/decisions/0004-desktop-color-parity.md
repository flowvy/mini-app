...
Проверены все 25 Mini App routes, 60 CSS-файлов, 86 TSX-файлов и color-bearing TS/SVG surfaces.
...
| `pages/admin/{dashboard,settings-access,settings,users-skeleton,users}.module.css`, `pages/{home,stub-page,support}.module.css` | Dashboard/Profile lists, Settings surfaces, Profiles loading, neutral empty/stub and negative real-error roles |
