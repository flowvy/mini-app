...
Runbook — проверенная пошаговая процедура для повторяемой эксплуатации или инцидента. У Flowvy есть
воспроизводимый Compose-контур и инструкция самостоятельной установки, но нет подтверждённого
развёртывания на реальном сервере, мониторинга, проверенного восстановления из резервной копии или
дежурной команды. Поэтому **production runbooks отсутствуют**. Не превращайте предположение в
инструкцию, способную изменить реальные данные.
