...
const desktopValues: Record<string, string[]> = {
	...
	"--v2-text-positive": ["#3ab176", "#49dd93"],
	"--v2-text-negative": ["#c6352a", "#f84235"],
	"--v2-text-warning": ["#f3ab11", "#ffcb2f"],
	...
	"--v2-icon-positive": ["#3ab176", "#49dd93"],
	"--v2-icon-negative": ["#c6352a", "#f84235"],
	"--v2-icon-warning": ["#f3ab11", "#ffcb2f"],
	"--v2-border-primary": ["#454545", "#a3a3a3"],
	"--v2-border-secondary": ["#c7c7c7", "#424242"],
	"--v2-border-tertiary": ["#e6e6e6", "#252525"],
	"--v2-border-positive-primary": ["#3ab176", "#49dd93"],
	"--v2-border-positive-secondary": ["#c6edd9", "#256042"],
	"--v2-border-negative-primary": ["#c6352a", "#f84235"],
	"--v2-border-negative-secondary": ["#fdbdb8", "#652722"],
	"--v2-border-warning-primary": ["#f3ab11", "#ffcb2f"],
	...
	"--v2-syntax-string": ["#3ab176", "#a9dc76"],
